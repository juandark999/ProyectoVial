...
<div class="container">
    <div  id="registro_usu">
<form id="myform" action="<?php echo getUrl("Usuario", "Usuario", "postUpdate"); ?>" onsubmit="return validar(this)" method="POST">
<?php
...
?>
   ...
   <div class="form-row">
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="nickname" name="nickname" placeholder="<?php echo $usu['usu_nickname']; ?>">
            <p class="text-danger"><small id="v_nickname"></small></p>
        </div>
        <div class="form-group col-md-4">
            <label for="nombre">Nombre Completo</label>
            <input type="text" class="form-control" id="nombre" name="nombre" placeholder="<?php echo $usu['usu_nombre']; ?>">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" id="celular" name="celular" placeholder="<?php echo $usu['usu_cel']; ?>">
    ...
    <!-- dejo fuera a submit -->
    <div class="form-group" id="enviarE">
    ...
    <div class="form-group" id="volverC">
    <center><a href="<?php echo getUrl("Usuario","Usuario","getConsult"); ?>"><button class="btn btn-danger">Volver</button></a></center>  
    </div>
    </div>
</div>