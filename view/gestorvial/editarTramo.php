...
<div class="container">
    <div id="registro_usu">
        <form id="myformT" action="<?php echo getUrl("Gestorvial", "Gestorvial", "postUpdate"); ?>" onsubmit="return validarT(this)" method="POST">
            <?php
            foreach ($tramo as $tra) {
            ?>
                <div class="form-row">
                    <div class="form-group col-md-4">
                        <label for="fecha">Jerarquia</label>
                        <select name="jerarquia" id="jerarquia" class="form-control" aria-placeholder="<?php echo $tra['tra_jerarquia']; ?>">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="ejevial" name="ejevial" placeholder="<?php echo $tra['tra_ejevial']; ?>">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <input type="text" class="form-control" id="segmento" name="segmento" placeholder="<?php echo $tra['tra_segmento']; ?>" >
                        <small class="text-danger" id="v_segmento"></small>
                    </div>

                        <input type="hidden" name="id" value="<?php echo $_GET['tra_id']; ?>">
